          ...
          >
            <ul className='flex flex-col lg:flex-row list-none lg:ml-auto space-x-4'>
              <li className='nav-item'>
                <button onClick={didTapOrderListButton} type="button" className="py-2 px-4  bg-background hover:bg-primary focus:bg-primary focus:ring-offset-bg-primary text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                  My Order List
                </button>
              </li>
              <li className='nav-item'>
                <button onClick={didTapCreateOrderButton} type="button" className="py-2 px-4  bg-primary hover:bg-purple-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                  Create Order
                </button>
              </li>
              <li className='nav-item'>
                <button suppressHydrationWarning={true} onClick={didTapConnectButton} type="button" className="py-2 px-4 border border-primary hover:bg-primary focus:bg-primary focus:ring-offset-bg-primary text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                  {
